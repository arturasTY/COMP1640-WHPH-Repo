...
$sql = "SELECT Grp_Ideas.IdeasID, IdeasText, Comments, Grp_Ideas.UserID, views, anonym, Grp_employee.Name FROM Grp_Ideas INNER JOIN Grp_employee ON Grp_Ideas.UserID = Grp_employee.empID ORDER BY IdeasID ASC $limit";
