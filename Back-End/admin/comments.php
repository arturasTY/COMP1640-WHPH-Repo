...
try {
        $result = $db_connection->query("SELECT * FROM Grp_Comments ORDER BY CommentsID DESC");
    }
...
//        exit();
   ...
   foreach ($result as $row) {
        $comms[] = array('Id' => $row['CommentsID'], 'ideastext' => $row['EmpID'], 'psw' => $row['CommentsText'], 'ideacomment' => $row['idea_ID']);
   }
...
<head>
    <meta charset="UTF-8">
    <title>WHPH Administrator | Comments</title>
        ...
        <div class="row">
          ...
          <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <div class="export-block">
              <h2 class="submit-id">All Comments</h2>
            ...
            <div class="table-responsive">
              <table class="table table-striped table-bordered table-sm">
                ...
                <tbody>
                 <?php foreach($comms as $idea) : ?>
                  <tr>
                    <td><?php echo $idea['Id']; ?></td>
                    <td><?php echo substr($idea['psw'], 0, 40); ?></td>
                    <td>
